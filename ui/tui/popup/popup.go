...
func (p *PopupModel) Info(msg string, duration time.Duration) {
	p.MsgChan <- PopupMsg{
		Level:    "INFO",
		Msg:      msg,
		Duration: duration,
...
func (p *PopupModel) Error(msg string, duration time.Duration) {
	p.MsgChan <- PopupMsg{
		Level:    "ERROR",
		Msg:      msg,
		Duration: duration,
...
func (p *PopupModel) Success(msg string, duration time.Duration) {
	p.MsgChan <- PopupMsg{
		Level:    "SUCCESS",
		Msg:      msg,
		Duration: duration,
